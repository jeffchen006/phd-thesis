...
\begin{itemize}
    ...
    \item \textbf{Auditing malicious endpoints in production LLMs (Chapter~2).}
    ...
    documentation-level poisoning (Chapter~3).}
    ...
    \item \textbf{Runtime invariants for deployed smart contracts (Chapter~4).}
    ...
    \item \textbf{Control-flow integrity for smart contracts (Chapter~5).}
