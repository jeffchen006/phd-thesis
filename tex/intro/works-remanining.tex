...
and Layer IV extends the security layer to an upstream channel:
...
rank poisoning, content poisoning, and consensus poisoning.
...
\begin{itemize}
    ...
    \item deployment-oriented guidance for reducing upstream AI-assisted development risk.
\end{itemize}
